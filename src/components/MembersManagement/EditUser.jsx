...
const EditUser = ({ modalOpenEdit, editContactId, closeEdit, handleEditFormSubmit, handleEditFormChange, editFormData }) => {
          ...
          <Modal.Body>
            ...
            >
              ...
              <div className="input-group mb-2">
                ...
                <input value={editFormData.birth} name="birth" id="startDate" className="form-control " type="date" onChange={handleEditFormChange} />
              </div>
