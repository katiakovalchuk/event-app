...
const PasswordRecovery = () => {
    ...
    useEffect(() => {
        ...
        if (error === "") {
            updateToastContent("Processed successfully", "Reset password link has been sent! Please, check email!");
            showToast();
            setTimeout(() => {
                navigate("/login");
            }, 1000)
    ...
    return (
        <>
            ...
            <div
                className={`Recovery d-flex justify-content-center align-items-center w-100 vh-100 ${error === "" ? "d-none" : ""}`}>
