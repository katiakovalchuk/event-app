...
export const getUsers = createAsyncThunk("usersSlice/getUsers", async (_, { rejectWithValue }) => {
  try {
...
export const addNewUser = createAsyncThunk("usersSlice/addNewUser", async (newUser, { rejectWithValue }) => {
  try {
...
export const updateUser = createAsyncThunk("usersSlice/updateUser", async (updatedUser, { rejectWithValue }) => {
...
export const deleteUser = createAsyncThunk("usersSlice/deleteUser", async (id, { rejectWithValue }) => {
  try {
