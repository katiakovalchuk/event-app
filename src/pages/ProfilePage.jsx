...
const ProfilePage = () => {
    ...
    return (
        <section id="profile" className="pt-4">
            <Container>
                <ModalForm
                    title="Please, type Your password to continue"
                    form={<ConfirmSignIn updatedUser={updatedUser} newEmail={addFormData.email}/>}
                />
                <Toast
                    toastHeading="Failed to change profile data"
                    toastText="Try again. Pay attention to submit correct password."
                    variant="warning"
                />
                <Row>
                    <Col md={8}>
                        ...
                        <div className="card shadow rounded mt-3">
                            ...
                            <div className="d-flex flex-row m-2 p-2">
                                <div className="p-1">
                                    <label htmlFor="file">
                                        <img className="icon"
                                             src={require("../assets/images/profile/folder-upload.png")} alt="upload"
                                             height={64}/>
                                    </label>
