          ...
          <Col md={8}>
            <form onSubmit={handleAdd}>
              ...
              <div class="mb-4 input-group w-75">
                ...
                <input type="text" id="name" class="form-control" placeholder="e.g. Max" />
              </div>
              ...
              <div class="input-group mb-4 w-75">
                ...
                <input type="text" id="email" class="form-control" placeholder="e.g. user@example.com" />
              </div>
              ...
              <div class="input-group mb-4 w-75">
                ...
                <input type="text" id="number" class="form-control" placeholder="e.g. 099 123 44 55" />
              </div>

              <label for="firm" class="form-label">
                Company:
              </label>
              <div class="input-group mb-4 w-75">
                <span class="input-group-text ms-0">
                ...
                <input type="text" id="firm" class="form-control" placeholder="e.g. Apple" />
              </div>
              ...
              <div class="input-group mb-4 w-75">
                ...
                <input type="date" id="birth" class="form-control" placeholder="e.g. Apple" />
              </div>
